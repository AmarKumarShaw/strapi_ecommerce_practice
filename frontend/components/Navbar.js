    ...
    <div>
      <header className="text-gray-600 body-font">
        ...
        <Link href="/"><a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
            ...
            <span className="ml-3 text-xl">ArMa shop</span>
          </a></Link>
          ...
          <button className="my-2 text-white bg-indigo-500 border-0 py-1 md:py-2 px-2 md:px-4 focus:outline-none hover:bg-indigo-600 rounded text-sm">Log In
          </button>
        </div>
      </header>
    </div>
