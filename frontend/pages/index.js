  ...
  return (
    <div className='container mx-auto px-4'>
      <section className="text-gray-600 body-font">
        <img className='object-none object-center bg-yellow-300 w-[100vw] h-[50vh]' src="bg.jpg" alt="" />
        <div className="container px-5 py-24 mx-auto">
          ...
          <button className="flex mx-auto mt-16 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Shopping Now</button>
        </div>
      </section></div>
  )
}
